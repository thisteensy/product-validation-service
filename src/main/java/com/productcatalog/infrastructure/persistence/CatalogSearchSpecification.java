...
public class CatalogSearchSpecification {
    ...
    public static Specification<TrackEntity> hasIsrc(String isrc) {
        return (root, query, cb) -> isrc == null ? null :
                cb.like(cb.lower(root.get("isrc")), "%" + isrc.toLowerCase() + "%");
    }
